...
Public Class CreditMemo
    ...
    Sub CreateCreditMemoForm(ByVal FormUID As String)
        Try
            ...
            oItem.Left = frmCreditMemo.Items.Item("16").Left + frmCreditMemo.Items.Item("16").Left + 50
            oItem.Width = frmCreditMemo.Items.Item("23").Width + 10
            oItem.Height = frmCreditMemo.Items.Item("23").Height
            oItem.Top = frmCreditMemo.Items.Item("23").Top
            oItem.Visible = True
            oLabel = oItem.Specific
            ...
            frmCreditMemo.Items.Item("t_XmlGen").LinkTo = "23"
            ...
            oItem.Left = frmCreditMemo.Items.Item("t_Xm1Gen").Left
            ...
            'End If
                    ...
                    Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                        Try
                            ...
                            Select Case pVal.ItemUID
                                Case "1"
                                    If pVal.ActionSuccess And frmCreditMemo.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                                        Me.InitForm()
                                    End If
                                Case "terms"
    ...
    Function XMLCreation12(PIH As String, ICV As String)
        Try
            ...
            If rset11.RecordCount > 0 Then
                ...
                xmlstring += vbCrLf & "<cbc: TaxableAmount currencyID= """ & TaxCurrency & """>" & Total & "</cbc: TaxableAmount>"
                xmlstring += vbCrLf & "<cbc: TaxAmount currencyID= """ & TaxCurrency & """>" & Vatsum & "</cbc: TaxAmount>"
                xmlstring += vbCrLf & "<cac: TaxCategory>"
                xmlstring += vbCrLf & "<cbc: ID schemeID=""UN/ECE 5305"" schemeAgencyID=""6"">S</cbc: ID>"
                xmlstring += vbCrLf & "<cbc: Percent>" & rATEE & "</cbc:Percent>"
                ...
                xmlstring += vbCrLf & "<cbc: TaxInclusiveAmount currencyID=""" & TaxCurrency & """>" & TaxinAmnt & "</cbc: TaxInclusiveAmount>"
    ...
    Sub xml()
        Try
            ...
            If XMLString <> "" Then
                ...
                Dim Name As String = "CreditMemo" & oDBDSHeader.GetValue("DocNum", 0).Trim & ".xml"
