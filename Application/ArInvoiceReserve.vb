...
Public Class ArInvoiceReserve
    ...
    Sub CreateARInvoiceForm(ByVal FormUID As String)
        Try
            ...
            oItem.Height = frmARInvoiceReserve.Items.Ite("20").Height
            ...
            oItem.Width = frmARInvoiceReserve.Items.Ite("XmlGen").Width
            ...
            oItem.Left = frmARInvoiceReserve.Items.Ite("XmlGen").Left
            ...
            oItem.Width = frmARInvoiceReserve.Items.Ite("t_XmlGen").Width
            oItem.Height = frmARInvoiceReserve.Items.Ite("t_XmlGen").Height
            ...
            frmARInvoiceReserve.Items.Ite("t_GenUName").LinkTo = "t_XmlGen"
            ...
            oItem.Left = frmARInvoiceReserve.Items.Ite("t_GenUName").Left
            ...
            frmARInvoiceReserve.Items.Itemm("GenDate").LinkTo = "t_GenDate"
            frmARInvoiceReserve.Items.Ite("t_GenDate").LinkTo = "t_GenUName"
            ...
            oItem.Height = frmARInvoiceReserve.Items.Ite("GenDate").Height
            ...
            oItem.Left = frmARInvoiceReserve.Items.Ite("t_GenDate").Left
            ...
            frmARInvoiceReserve.Items.Ite("t_CStatus").LinkTo = "t_GenDate"
            ...
            oItem.Left = frmARInvoiceReserve.Items.Ite("t_CStatus").Left
            oItem.Width = frmARInvoiceReserve.Items.Ite("t_CStatus").Width
            ...
            frmARInvoiceReserve.Items.Ite("t_AStatus").LinkTo = "t_CStatus"

            ''Electronic tab

            oItem = frmARInvoiceReserve.Items.Add("APIPOST", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Ite("TaxType").Left - 30
            oItem.Width = frmARInvoiceReserve.Items.Ite("TaxType").Width
            ...
            frmARInvoiceReserve.Items.Ite("Cert").LinkTo = "t_Cert"
            ...
            oItem.Left = frmARInvoiceReserve.Items.Ite("t_Cert").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_Cert").Width
            oItem.Height = frmARInvoiceReserve.Items.Ite("t_Cert").Height
            ...
            frmARInvoiceReserve.Items.Ite("XMLGen1").LinkTo = "t_XMLGen1"
            ...
            oItem.Top = frmARInvoiceReserve.Items.Ite("XMLGen1").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem.Height = frmARInvoiceReserve.Items.Ite("t_XMLGen1").Height
            ...
            oItem.Top = frmARInvoiceReserve.Items.Ite("GenUID").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem.Left = frmARInvoiceReserve.Items.Ite("CSID").Left
            ...
            oItem.Left = frmARInvoiceReserve.Items.Ite("t_CSID").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_CSID").Width
            oItem.Height = frmARInvoiceReserve.Items.Ite("t_CSID").Height
            ...
            oItem.Height = frmARInvoiceReserve.Items.Ite("t_HASH").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_HASH").Top + frmARInvoiceReserve.Items.Item("t_HASH").Height + 1
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            ...
            frmARInvoiceReserve.Items.Ite("QRCode").LinkTo = "t_QRCode"
            frmARInvoiceReserve.Items.Ite("t_QRCode").LinkTo = "t_HASH"
            ...
            oItem.Top = frmARInvoiceReserve.Items.Ite("PIH").Top
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            oItem = frmARInvoiceReserve.Items.Add("b_Load1", SAPbouiCOM.BoFormItemTypes.it_BUTTON)
            oItem.Left = frmARInvoiceReserve.Items.Item("b_Load").Left + frmARInvoiceReserve.Items.Item("b_Load").Width + 10
            oItem.Width = frmARInvoiceReserve.Items.Item("b_Load").Width + 50
            oItem.Height = frmARInvoiceReserve.Items.Item("b_Load").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("b_Load").Top
            oItem.Visible = False
            oItem.Enabled = True
            oButton = oItem.Specific
    ...
    Sub InitForm()
        Try
            ...
            frmARInvoiceReserve.Items.Ite("t_XmlGen").Enabled = False
            frmARInvoiceReserve.Items.Ite("t_XMLGen1").Enabled = False
            ...
            frmARInvoiceReserve.Items.Ite("t_CSID").Enabled = False
            frmARInvoiceReserve.Items.Ite("t_APITime").Enabled = False

            frmARInvoiceReserve.Items.Ite("t_HASH").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_QRCode").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_PIH").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_APIPOST").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_AStatus").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_CStatus").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_XmlGen").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_GenUID").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_GenUName").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_Cert").Specific.Value = ""
            frmARInvoiceReserve.Items.Ite("t_GenDate").Specific.Value = ""
                ...
                Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_LOAD
                    Try
                        If BusinessObjectInfo.ActionSuccess Then
                            ...
                            'frmARInvoiceReserve . Items. Item("t_PIH"). Enabled = False
                            frmARInvoiceReserve.Items.Ite("t_PIH").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            ...
                            frmARInvoiceReserve.Items.Ite("t_APIPOST").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            ...
                            If (rsetPrjt1.Fields.Item("XMLAproved").Value = "Y") Then
                                    ...
                                    Else
                                        ...
                                        If rset.RecordCount > 0 Then
                                            ...
                                            Else
                                                ...
                                                frmARInvoiceReserve.Items.Ite("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                            End If
                                        Else
                                            frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                            frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                ...
                                ElseIf oDBDSHeader.GetValue("U_CLEARANCESTATUS", 0).Trim = "FAILED" Then
                                    ...
                                    Else
                                        ...
                                        frmARInvoiceReserve.Items.Ite("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                    End If
