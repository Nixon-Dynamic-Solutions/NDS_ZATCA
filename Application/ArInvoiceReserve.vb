...
Public Class ArInvoiceReserve
    Public frmARInvoiceReserve As SAPbouiCOM.Form
    ...
    Sub CreateARInvoiceForm(ByVal FormUID As String)
        Try
            ...
            frmARInvoiceReserve = oApplication.Forms.Item(FormUID)
            oDBDSHeader = frmARInvoiceReserve.DataSources.DBDataSources.Item("OINV")
            oDBDSDetail = frmARInvoiceReserve.DataSources.DBDataSources.Item("INV1")
            oMatrix = frmARInvoiceReserve.Items.Item("38").Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("TaxType", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("86").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("86").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("86").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("86").Top + 32 + 32
            oItem.Visible = True
            oLabel = oItem.Specific
            oLabel.Caption = "Tax Category Code"

            oItem = frmARInvoiceReserve.Items.Add("t_TaxType", SAPbouiCOM.BoFormItemTypes.it_COMBO_BOX)
            oItem.Left = frmARInvoiceReserve.Items.Item("46").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("46").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("46").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("46").Top + 32 + 32
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oCombobox = oItem.Specific
            oCombobox.DataBind.SetBound(True, "OINV", "U_ZATCA_TaxCode")
            frmARInvoiceReserve.Items.Item("TaxType").LinkTo = "t_TaxType"

            frmARInvoiceReserve.DataSources.UserDataSources.Add("oFolder", SAPbouiCOM.BoDataType.dt_SHORT_TEXT)
            oItem = frmARInvoiceReserve.Items.Add("terms", SAPbouiCOM.BoFormItemTypes.it_FOLDER)
            oItem.Top = frmARInvoiceReserve.Items.Item("2013").Top
            oItem.Left = frmARInvoiceReserve.Items.Item("2013").Left + frmARInvoiceReserve.Items.Item("2013").Width
            oItem.Width = frmARInvoiceReserve.Items.Item("2013").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("2013").Height
            oItem.Visible = True
            oItem.Enabled = True
            oItem.FromPane = 0
            oItem.ToPane = 0
            ...
            oItem = frmARInvoiceReserve.Items.Add("XmlGen", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("20").Left + frmARInvoiceReserve.Items.Item("20").Width + 50
            oItem.Width = frmARInvoiceReserve.Items.Item("20").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("20").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("20").Top
            oItem.Visible = True
            oLabel = oItem.Specific
            oLabel.Caption = "E-Invoice Generation Status"

            oItem = frmARInvoiceReserve.Items.Add("t_XmlGen", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("XmlGen").Left + frmARInvoiceReserve.Items.Item("XmlGen").Width + 20
            oItem.Width = frmARInvoiceReserve.Items.Item("XmlGen").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("XmlGen").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("XmlGen").Top
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oEditText = oItem.Specific
            oEditText.DataBind.SetBound(True, "OINV", "U_XMLGENERATION")
            frmARInvoiceReserve.Items.Item("XmlGen").LinkTo = "t_XmlGen"
            frmARInvoiceReserve.Items.Item("t_XmlGen").LinkTo = "20"

            oItem = frmARInvoiceReserve.Items.Add("GenUName", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("XmlGen").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("XmlGen").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("XmlGen").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("XmlGen").Top + 16
            oItem.Visible = True
            oLabel = oItem.Specific
            oLabel.Caption = "E-Invoice Generated By"

            oItem = frmARInvoiceReserve.Items.Add("t_GenUName", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_XmlGen").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_XmlGen").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_XmlGen").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_XmlGen").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oEditText = oItem.Specific
            oEditText.DataBind.SetBound(True, "OINV", "U_GenUName")
            frmARInvoiceReserve.Items.Item("GenUName").LinkTo = "t_GenUName"
            frmARInvoiceReserve.Items.Item("t_GenUName").LinkTo = "t_XmlGen"

            oItem = frmARInvoiceReserve.Items.Add("GenDate", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("GenUName").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("GenUName").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("GenUName").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("GenUName").Top + 16
            oItem.Visible = True
            oLabel = oItem.Specific
            oLabel.Caption = "E-Invoice Generated On"

            oItem = frmARInvoiceReserve.Items.Add("t_GenDate", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_GenUName").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_GenUName").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_GenUName").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_GenUName").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oEditText = oItem.Specific
            oEditText.DataBind.SetBound(True, "OINV", "U_GenDate")
            frmARInvoiceReserve.Items.Item("GenDate").LinkTo = "t_GenDate"
            frmARInvoiceReserve.Items.Item("t_GenDate").LinkTo = "t_GenUName"

            oItem = frmARInvoiceReserve.Items.Add("CStatus", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("GenDate").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("GenDate").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("GenDate").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("GenDate").Top + 16
            oItem.Visible = True
            oLabel = oItem.Specific
            oLabel.Caption = "Clearance Status"
            oItem = frmARInvoiceReserve.Items.Add("t_CStatus", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_GenDate").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_GenDate").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_GenDate").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_GenDate").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oEditText = oItem.Specific
            oEditText.DataBind.SetBound(True, "OINV", "U_CLEARANCESTATUS")
            frmARInvoiceReserve.Items.Item("CStatus").LinkTo = "t_CStatus"
            frmARInvoiceReserve.Items.Item("t_CStatus").LinkTo = "t_GenDate"

            oItem = frmARInvoiceReserve.Items.Add("AStatus", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("CStatus").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("CStatus").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("CStatus").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("CStatus").Top + 16
            oItem.Visible = True
            oLabel = oItem.Specific
            oLabel.Caption = "Clearance Status Details"

            oItem = frmARInvoiceReserve.Items.Add("t_AStatus", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_CStatus").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_CStatus").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_CStatus").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_CStatus").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oEditText = oItem.Specific
            oEditText.DataBind.SetBound(True, "OINV", "U_APIStatus")
            frmARInvoiceReserve.Items.Item("AStatus").LinkTo = "t_AStatus"
            frmARInvoiceReserve.Items.Item("t_AStatus").LinkTo = "t_CStatus"

            ''Electronic tab

            oItem = frmARInvoiceReserve.Items.Add("APIPOST", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("TaxType").Left - 30
            oItem.Width = frmARInvoiceReserve.Items.Item("TaxType").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("TaxType").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("TaxType").Top + 60
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_APIPOST", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_TaxType").Left - 30
            oItem.Width = frmARInvoiceReserve.Items.Item("t_TaxType").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_TaxType").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_TaxType").Top + 60
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            frmARInvoiceReserve.Items.Item("APIPOST").LinkTo = "t_APIPOST"

            oItem = frmARInvoiceReserve.Items.Add("Cert", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("APIPOST").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("APIPOST").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("APIPOST").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("APIPOST").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_Cert", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_APIPOST").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_APIPOST").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_APIPOST").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_APIPOST").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            frmARInvoiceReserve.Items.Item("Cert").LinkTo = "t_Cert"

            oItem = frmARInvoiceReserve.Items.Add("XMLGen1", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("Cert").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("Cert").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("Cert").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("Cert").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_XMLGen1", SAPbouiCOM.BoFormItemTypes.it_COMBO_BOX)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_Cert").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_Cert").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_Cert").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_Cert").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            frmARInvoiceReserve.Items.Item("XMLGen1").LinkTo = "t_XMLGen1"

            oItem = frmARInvoiceReserve.Items.Add("GenUID", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("XMLGen1").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("XMLGen1").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("XMLGen1").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("XMLGen1").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_GenUID", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_XMLGen1").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_XMLGen1").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_XMLGen1").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_XMLGen1").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            frmARInvoiceReserve.Items.Item("GenUID").LinkTo = "t_GenUID"

            oItem = frmARInvoiceReserve.Items.Add("CSID", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("GenUID").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("GenUID").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("GenUID").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("GenUID").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_CSID", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_GenUID").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_GenUID").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_GenUID").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_GenUID").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            frmARInvoiceReserve.Items.Item("CSID").LinkTo = "t_CSID"

            oItem = frmARInvoiceReserve.Items.Add("APITime", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("CSID").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("CSID").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("CSID").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("CSID").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_APITime", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_CSID").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_CSID").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_CSID").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_CSID").Top + 16
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            frmARInvoiceReserve.Items.Item("APITime").LinkTo = "t_APITime"

            oItem = frmARInvoiceReserve.Items.Add("HASH", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("256000704").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("2000").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("2000").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("2000").Top + 70
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_HASH", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("2001").Left + 140
            oItem.Width = frmARInvoiceReserve.Items.Item("2001").Width + 100
            oItem.Height = 35 ''frmCreditMemo. Items. Item("16"). Height
            oItem.Top = frmARInvoiceReserve.Items.Item("2001").Top + 70
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            frmARInvoiceReserve.Items.Item("HASH").LinkTo = "t_HASH"
            oItem = frmARInvoiceReserve.Items.Add("QRCode", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("HASH").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("HASH").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("HASH").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_HASH").Top + frmARInvoiceReserve.Items.Item("t_HASH").Height + 1
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_QRCode", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_HASH").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_HASH").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_HASH").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_HASH").Top + frmARInvoiceReserve.Items.Item("t_HASH").Height + 1
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            ...
            frmARInvoiceReserve.Items.Item("QRCode").LinkTo = "t_QRCode"
            frmARInvoiceReserve.Items.Item("t_QRCode").LinkTo = "t_HASH"

            oItem = frmARInvoiceReserve.Items.Add("PIH", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoiceReserve.Items.Item("QRCode").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("QRCode").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("QRCode").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("t_QRCode").Top + frmARInvoiceReserve.Items.Item("t_QRCode").Height + 1
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem = frmARInvoiceReserve.Items.Add("t_PIH", SAPbouiCOM.BoFormItemTypes.it_EXTEDIT)
            oItem.Left = frmARInvoiceReserve.Items.Item("t_QRCode").Left
            oItem.Width = frmARInvoiceReserve.Items.Item("t_QRCode").Width
            oItem.Height = frmARInvoiceReserve.Items.Item("t_QRCode").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("PIH").Top
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            frmARInvoiceReserve.Items.Item("PIH").LinkTo = "t_PIH"
            frmARInvoiceReserve.Items.Item("t_PIH").LinkTo = "t_HASH"
            'oItem = frmARInvoiceReserve. Items. Add("b_Load1", SAPbouiCOM. BoFormItemTypes. it_BUTTON)

            oItem = frmARInvoiceReserve.Items.Add("b_Load", SAPbouiCOM.BoFormItemTypes.it_BUTTON)
            oItem.Left = frmARInvoiceReserve.Items.Item("2").Left + frmARInvoiceReserve.Items.Item("2").Width + 10
            oItem.Width = frmARInvoiceReserve.Items.Item("2").Width + 50
            oItem.Height = frmARInvoiceReserve.Items.Item("2").Height
            oItem.Top = frmARInvoiceReserve.Items.Item("2").Top
            oItem.Visible = False
            oItem.Enabled = False
            ...
            Me.InitForm()
            boolFormLoaded = True
            frmARInvoiceReserve.Freeze(False)
    ...
    Sub InitForm()
        Try
            frmARInvoiceReserve.Freeze(True)
            frmARInvoiceReserve.Items.Item("b_Load").Visible = False
            frmARInvoiceReserve.Items.Item("b_Load1").Visible = False
            frmARInvoiceReserve.Items.Item("t_TaxType").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
            frmARInvoiceReserve.Items.Item("t_TaxType").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
            frmARInvoiceReserve.Items.Item("t_TaxType").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
            'oGfun.setComboBoxValue(frmARInvoiceReserve.Items.Item("t_TaxType").Specific, "EXEC [ TaxType] ''")
            oGfun.setComboBoxValue(frmARInvoiceReserve.Items.Item("t_TaxType").Specific, "CALL ""TaxType""('')")
            frmARInvoiceReserve.Items.Item("t_HASH").Enabled = False
            frmARInvoiceReserve.Items.Item("t_QRCode").Enabled = False
            frmARInvoiceReserve.Items.Item("t_PIH").Enabled = False
            frmARInvoiceReserve.Items.Item("t_APIPOST").Enabled = False
            frmARInvoiceReserve.Items.Item("t_AStatus").Enabled = False
            frmARInvoiceReserve.Items.Item("t_CStatus").Enabled = False
            frmARInvoiceReserve.Items.Item("t_XmlGen").Enabled = False
            frmARInvoiceReserve.Items.Item("t_XMLGen1").Enabled = False
            frmARInvoiceReserve.Items.Item("t_GenUID").Enabled = False
            frmARInvoiceReserve.Items.Item("t_GenUName").Enabled = False
            frmARInvoiceReserve.Items.Item("t_Cert").Enabled = False
            frmARInvoiceReserve.Items.Item("t_GenDate").Enabled = False
            frmARInvoiceReserve.Items.Item("t_CSID").Enabled = False
            frmARInvoiceReserve.Items.Item("t_APITime").Enabled = False

            frmARInvoiceReserve.Items.Item("t_HASH").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_QRCode").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_PIH").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_APIPOST").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_AStatus").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_CStatus").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_XmlGen").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_GenUID").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_GenUName").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_Cert").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_GenDate").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_CSID").Specific.Value = ""
            frmARInvoiceReserve.Items.Item("t_APITime").Specific.Value = ""
            frmARInvoiceReserve.Freeze(False)
        Catch ex As Exception
            frmARInvoiceReserve.Freeze(False)
                ...
                Select Case pVal.EventType
                            ...
                            Select Case pVal.ItemUID
                                Case "t_TaxType"
                                    If pVal.BeforeAction = False Then
                                        ...
                                        'oGfun.SetComboBoxValueRefresh(frmARInvoiceReserve.Items.Item("t_TaxType").Specific, "Exec [TaxType]'" & tax & "'")
                                        oGfun.SetComboBoxValueRefresh(frmARInvoiceReserve.Items.Item("t_TaxType").Specific, "CALL ""TaxType""('" & tax & "')")
                                    End If
                            End Select
                        Catch ex As Exception
                    ...
                    Case SAPbouiCOM.BoEventTypes.et_CLICK
                        Try
                            Select Case pVal.ItemUID
                                Case "1"
                                    If pVal.BeforeAction And (frmARInvoiceReserve.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Or frmARInvoiceReserve.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE) Then
                            ...
                            Select Case pVal.ItemUID
                                Case "1"
                                    If pVal.ActionSuccess Then
                                        If frmARInvoiceReserve.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                                            ...
                                            If rset.RecordCount > 0 And rset.Fields.Item(0).Value <> 0 Then
                                                'frmARInvoiceReserve.Mode = SAPbouiCOM.BoFormMode.fm_FIND_MODE
                                                'frmARInvoiceReserve.Items.Item("8").Specific.value = rset.Fields.Item(0).Value
                                                'frmARInvoiceReserve.Items.Item("1").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                                                'frmARInvoiceReserve.Items.Item("b_Load").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
                                ...
                                Case "terms"
                                    If pVal.BeforeAction = False Then
                                        frmARInvoiceReserve.PaneLevel = 60
                                    End If
                                Case "b_Load"
                                    If pVal.BeforeAction = False Then
                                        Me.xml()
    ...
    Function XMLCreationTST(PIH As String, ICV As String)
        Try
            ...
            If rset11.RecordCount > 0 Then
                ...
                Dim Datel As Date = Date.ParseExact(frmARInvoiceReserve.Items.Item("10").Specific.value, "yyyyMMdd", Nothing)
                Dim newdate As String = Datel.ToString("yyyy-MM-dd")
                Dim Date2 As Date = Date.ParseExact(frmARInvoiceReserve.Items.Item("12").Specific.value, "yyyyMMdd", Nothing)
    ...
    Function XMLCreation12(PIH As String, ICV As String)
        Try
            ...
            If rset11.RecordCount > 0 Then
                ...
                xmlstring += vbCrLf & "<cbc:ID>" & rset11.Fields.Item("DocNum").Value & "</cbc:ID>"
                xmlstring += vbCrLf & "<cbc:UUID>" & rset11.Fields.Item("UUID").Value & "</cbc:UUID>"
                Dim Date1 As Date = Date.ParseExact(frmARInvoiceReserve.Items.Item("10").Specific.value, "yyyyMMdd", Nothing)
    ...
    Sub xml()
        Try
            ...
            If XMLString <> "" Then
                ...
                'frmARInvoiceReserve. Items. Item("b_delete"). Enabled = False
    ...
    Sub FormDataEvent(ByRef BusinessObjectInfo As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean)
        Try
            ...
            Select Case BusinessObjectInfo.EventType
                ...
                '            ''Me. Jsonstring( )
                '            If frmARInvoiceReserve.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                ...
                Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_ADD, SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE
                    Try
                        ...
                        If BusinessObjectInfo.BeforeAction = False And BusinessObjectInfo.ActionSuccess = True Then
                            ...
                            If BusinessObjectInfo.FormTypeEx = "60091" Then
                                        ...
                                        If frmARInvoiceReserve.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                                            ...
                                            AddHandler t.Tick,
                                                Sub()
                                                    t.Stop()
                                                    Try
                                                        frmARInvoiceReserve.Select()
                                                        frmARInvoiceReserve.Mode = SAPbouiCOM.BoFormMode.fm_FIND_MODE
                                                        frmARInvoiceReserve.Items.Item("8").Click()
                                                        frmARInvoiceReserve.Items.Item("8").Specific.Value = docNum
                ...
                Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_LOAD
                    Try
                        If BusinessObjectInfo.ActionSuccess Then
                            'frmARInvoiceReserve. Mode = SAPbouiCOM. BoFormMode. fm_UPDATE_MODE

                            frmARInvoiceReserve.Items.Item("t_TaxType").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_TaxType").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_TaxType").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)

                            frmARInvoiceReserve.Items.Item("t_HASH").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_HASH").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_HASH").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            ' frmARInvoiceReserve. Items. Ite("t_QRCode") . Enabled = False
                            frmARInvoiceReserve.Items.Item("t_QRCode").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_QRCode").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_QRCode").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            'frmARInvoiceReserve. Items. Item("t_PIH"). Enabled = False
                            frmARInvoiceReserve.Items.Item("t_PIH").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_PIH").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_PIH").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_APIPOST").Enabled = False
                            frmARInvoiceReserve.Items.Item("t_APIPOST").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_APIPOST").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_APIPOST").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            'frmARInvoiceReserve. Items. Ite("t_AStatus"). Enabled = False
                            frmARInvoiceReserve.Items.Item("t_AStatus").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_AStatus").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_AStatus").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            'frmARInvoiceReserve. Items. Item("t_CStatus"). Enabled = False
                            frmARInvoiceReserve.Items.Item("t_CStatus").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_CStatus").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_CStatus").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            'frmARInvoiceReserve. Items. Item("t_XmlGen") . Enabled = False
                            frmARInvoiceReserve.Items.Item("t_XmlGen").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_XmlGen").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_XmlGen").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            ' frmARInvoiceReserve. Items. Item("t_GenUID"). Enabled = False
                            frmARInvoiceReserve.Items.Item("t_XMLGen1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_XMLGen1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_XMLGen1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenUID").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenUID").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenUID").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenUName").Enabled = False
                            frmARInvoiceReserve.Items.Item("t_GenUName").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenUName").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenUName").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            'frmARInvoiceReserve. Items. Item("t_Cert") . Enabled = False
                            frmARInvoiceReserve.Items.Item("t_Cert").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_Cert").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_Cert").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenDate").Enabled = False
                            frmARInvoiceReserve.Items.Item("t_GenDate").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenDate").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_GenDate").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_CSID").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_CSID").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_CSID").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_APITime").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_APITime").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            frmARInvoiceReserve.Items.Item("t_APITime").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            ...
                            If (rsetPrjt1.Fields.Item("XMLAproved").Value = "Y") Then
                                ...
                                If oDBDSHeader.GetValue("U_CLEARANCESTATUS", 0).Trim = "CLEARED" Then
                                    ...
                                    frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                    frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                ElseIf oDBDSHeader.GetValue("U_CLEARANCESTATUS", 0).Trim = "" Then

                                    If File.Exists(path1) Then

                                        frmARInvoiceReserve.Items.Item("b_Load1").Visible = True
                                        frmARInvoiceReserve.Items.Item("b_Load").Visible = False

                                        frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                        frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                        frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                        frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 3, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                    ...
                                    Else
                                        ...
                                        If rset.RecordCount > 0 Then
                                            ...
                                            'frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                            '        frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                            '        frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                            'End If
                                        Else
                                            frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                            frmARInvoiceReserve.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                ...
                                ElseIf oDBDSHeader.GetValue("U_CLEARANCESTATUS", 0).Trim = "FAILED" Then
                                    ...
                                    'If File.Exists(path1) Then
                                    '    frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                    '    frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                    '    frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                    'Else
                                    frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                    frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                    frmARInvoiceReserve.Items.Item("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
            ...
            If pVal.BeforeAction = False Then
                ...
                Select Case pVal.MenuUID
                    Case "1282"
                        Me.InitForm()
                    Case "1287"
                        frmARInvoiceReserve.Items.Item("350002087").Click()
                        Me.InitForm()
                End Select
            End If
        Catch ex As Exception
