...
Public Class ArInvoicePayment
    ...
    Sub CreateARInvoiceForm(ByVal FormUID As String)
        Try
            ...
            oItem.Height = frmARInvoicePayment.Items.Ite("20").Height
            ...
            oItem.Width = frmARInvoicePayment.Items.Ite("XmlGen").Width
            ...
            oItem.Left = frmARInvoicePayment.Items.Ite("XmlGen").Left
            ...
            oItem.Width = frmARInvoicePayment.Items.Ite("t_XmlGen").Width
            oItem.Height = frmARInvoicePayment.Items.Ite("t_XmlGen").Height
            ...
            frmARInvoicePayment.Items.Ite("t_GenUName").LinkTo = "t_XmlGen"
            ...
            oItem.Left = frmARInvoicePayment.Items.Ite("t_GenUName").Left
            ...
            frmARInvoicePayment.Items.Itemm("GenDate").LinkTo = "t_GenDate"
            frmARInvoicePayment.Items.Ite("t_GenDate").LinkTo = "t_GenUName"
            ...
            oItem.Height = frmARInvoicePayment.Items.Ite("GenDate").Height
            ...
            oItem.Left = frmARInvoicePayment.Items.Ite("t_GenDate").Left
            ...
            frmARInvoicePayment.Items.Ite("t_CStatus").LinkTo = "t_GenDate"
            ...
            oItem.Left = frmARInvoicePayment.Items.Ite("t_CStatus").Left
            oItem.Width = frmARInvoicePayment.Items.Ite("t_CStatus").Width
            ...
            frmARInvoicePayment.Items.Ite("t_AStatus").LinkTo = "t_CStatus"

            ''Electronic tab

            oItem = frmARInvoicePayment.Items.Add("APIPOST", SAPbouiCOM.BoFormItemTypes.it_STATIC)
            oItem.Left = frmARInvoicePayment.Items.Ite("TaxType").Left - 30
            oItem.Width = frmARInvoicePayment.Items.Ite("TaxType").Width
            ...
            frmARInvoicePayment.Items.Ite("Cert").LinkTo = "t_Cert"
            ...
            oItem.Left = frmARInvoicePayment.Items.Ite("t_Cert").Left
            oItem.Width = frmARInvoicePayment.Items.Item("t_Cert").Width
            oItem.Height = frmARInvoicePayment.Items.Ite("t_Cert").Height
            ...
            frmARInvoicePayment.Items.Ite("XMLGen1").LinkTo = "t_XMLGen1"
            ...
            oItem.Top = frmARInvoicePayment.Items.Ite("XMLGen1").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem.Height = frmARInvoicePayment.Items.Ite("t_XMLGen1").Height
            ...
            oItem.Top = frmARInvoicePayment.Items.Ite("GenUID").Top + 16
            oItem.Visible = True
            oItem.FromPane = 60
            oItem.ToPane = 60
            oLabel = oItem.Specific
            ...
            oItem.Left = frmARInvoicePayment.Items.Ite("CSID").Left
            ...
            oItem.Left = frmARInvoicePayment.Items.Ite("t_CSID").Left
            oItem.Width = frmARInvoicePayment.Items.Item("t_CSID").Width
            oItem.Height = frmARInvoicePayment.Items.Ite("t_CSID").Height
            ...
            oItem.Height = frmARInvoicePayment.Items.Ite("t_HASH").Height
            oItem.Top = frmARInvoicePayment.Items.Item("t_HASH").Top + frmARInvoicePayment.Items.Item("t_HASH").Height + 1
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            ...
            frmARInvoicePayment.Items.Ite("QRCode").LinkTo = "t_QRCode"
            frmARInvoicePayment.Items.Ite("t_QRCode").LinkTo = "t_HASH"
            ...
            oItem.Top = frmARInvoicePayment.Items.Ite("PIH").Top
            oItem.Enabled = False
            oItem.DisplayDesc = 1
            oItem.FromPane = 60
            oItem.ToPane = 60
            ...
            oItem = frmARInvoicePayment.Items.Add("b_Load1", SAPbouiCOM.BoFormItemTypes.it_BUTTON)
            oItem.Left = frmARInvoicePayment.Items.Item("b_Load").Left + frmARInvoicePayment.Items.Item("b_Load").Width + 10
            oItem.Width = frmARInvoicePayment.Items.Item("b_Load").Width + 50
            oItem.Height = frmARInvoicePayment.Items.Item("b_Load").Height
            oItem.Top = frmARInvoicePayment.Items.Item("b_Load").Top
            oItem.Visible = False
            oItem.Enabled = True
            oButton = oItem.Specific
    ...
    Sub InitForm()
        Try
            ...
            frmARInvoicePayment.Items.Ite("t_XmlGen").Enabled = False
            frmARInvoicePayment.Items.Ite("t_XMLGen1").Enabled = False
            ...
            frmARInvoicePayment.Items.Ite("t_CSID").Enabled = False
            frmARInvoicePayment.Items.Ite("t_APITime").Enabled = False

            frmARInvoicePayment.Items.Ite("t_HASH").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_QRCode").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_PIH").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_APIPOST").Specific.Value = ""
            frmARInvoicePayment.Items.Item("t_AStatus").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_CStatus").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_XmlGen").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_GenUID").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_GenUName").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_Cert").Specific.Value = ""
            frmARInvoicePayment.Items.Ite("t_GenDate").Specific.Value = ""
                ...
                Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_LOAD
                    Try
                        If BusinessObjectInfo.ActionSuccess Then
                            ...
                            'frmARInvoicePayment. Items. Item("t_PIH"). Enabled = False
                            frmARInvoicePayment.Items.Ite("t_PIH").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            ...
                            frmARInvoicePayment.Items.Ite("t_APIPOST").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                            ...
                            If (rsetPrjt1.Fields.Item("XMLAproved").Value = "Y") Then
                                    ...
                                    Else
                                        ...
                                        If rset.RecordCount > 0 Then
                                            ...
                                            Else
                                                ...
                                                frmARInvoicePayment.Items.Ite("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                            End If
                                        Else
                                            frmARInvoicePayment.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 2, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                                            frmARInvoicePayment.Items.Item("b_Load").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                ...
                                ElseIf oDBDSHeader.GetValue("U_CLEARANCESTATUS", 0).Trim = "FAILED" Then
                                    ...
                                    Else
                                        ...
                                        frmARInvoicePayment.Items.Ite("b_Load1").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
                                    End If
